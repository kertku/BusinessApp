    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registry_number', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1000000), django.core.validators.MaxValueValidator(9999999)])),
                ('establishment_date', models.DateField(validators=[django.core.validators.MaxValueValidator(datetime.date(2022, 6, 21))])),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(through='base.Ownership', to='base.businessuser'),
        ),
        migrations.AddField(
            model_name='company',
            name='individual_owners',
            field=models.ManyToManyField(through='base.Ownership', to='base.user'),
        ),
    ]
